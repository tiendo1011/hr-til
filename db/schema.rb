...
ActiveRecord::Schema.define(version: 20160708201736) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.index ["channel_id"], name: "index_posts_on_channel_id", using: :btree
    t.index ["developer_id"], name: "index_posts_on_developer_id", using: :btree
    t.index ["slug"], name: "unique_slug", unique: true, using: :btree
  end
